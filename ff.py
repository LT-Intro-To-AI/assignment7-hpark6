...
fires = [
    ([7, 5, 86.2, 26.2, 94.3, 5.1, 8.2, 51, 6.7, 0], [0]), #line 2
    ([3, 4, 91, 129.5, 692.6, 7, 13.9, 59, 6.3, 0], [11.24]), #line 200
    ([8, 8, 91.7, 191.4, 635.9, 7.8, 26.2, 36, 4.5, 0], [185.76]), #line 422
    ([8, 6, 94.8, 222.4, 698.6, 13.9, 27.5, 27, 4.9, 0], [746.28])
]
